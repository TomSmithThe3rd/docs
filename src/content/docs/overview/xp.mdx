---
title: Experience
description: Overview of the experience (XP) system and leveling in Engauge.
sidebar:
  order: 1
---
...
[leaderboard](/overview/leaderboard), or the [dashboard](/setup/dashboard).
...
[currency](/setup/economy), [roles](/setup/roles), and more as you level up.
